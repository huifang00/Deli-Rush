...
public class MalayStallActivity extends AppCompatActivity implements QuantityDialog.QuantityDialogListener {
    //Initialize variable
...
//        cartData = (ArrayList<CartListData>) PrefConfigCartList.readListFromPref(this);
    ...
    private void createMenu() {
        ...
        malay_menu.add(new MenuListData("Nasi Lemak", "2.00"));
        malay_menu.add(new MenuListData("Nasi Kerabu", "7.00"));
        malay_menu.add(new MenuListData("Mee Goreng", "5.50"));
        malay_menu.add(new MenuListData("Laksa", "5.50"));

        MenuAdapter adapter = new MenuAdapter(this, malay_menu);
...
//                        PrefConfigCartList.writeListInPref(getApplicationContext(), cartData);
    ...
    public static void setPrice(String price) {
        MalayStallActivity.price = price;
    }
